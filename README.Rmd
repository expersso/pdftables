...
[PDFTables API](https://pdftables.com) which parses and returns the extracted data as a
`raw` vector. Finally, we write the result to a new `.xlsx` file which we can
open in Excel.
